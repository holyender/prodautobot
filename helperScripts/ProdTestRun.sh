...
echo "production run all tests script"
echo "cron job start"
...
#cd automationtests
#cd backstopjs
cd /home/bliu/automationtests/prodautobots/visRegTest
...
sudo cp /home/bliu/automationtests/prodautobots/userAcceptTest/tests/_output/report.html /var/www/html/

sudo cp /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/ci_report/xunit.xml /var/www/html/
...
sudo cp -R /home/bliu/automationtests/prodautobots/userAcceptTest/tests/_output /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/html_report

TIMESTAMP=$(date +%Y%m%d_%H%M%S)
sudo mv /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/html_report /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/Prod_"$TIMESTAMP"

sudo cp -R /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/bitmaps_test/* /var/www/html/report/backstop_data/bitmaps_test/
...
sudo cp -R /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/bitmaps_reference /var/www/html/report/backstop_data

sudo cp -R /home/bliu/automationtests/prodautobots/visRegTest/backstop_data/Prod_"$TIMESTAMP" /var/www/html/report/backstop_data

echo "prod test run completed check website for updates"
